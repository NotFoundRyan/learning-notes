...
- [数组与字符串](/notes/c/array-string) - 数组内存布局、指针运算、字符串处理
- [函数详解](/notes/c/function) - 参数传递、作用域、递归、函数指针
...
- [位运算](/notes/c/bitwise) - 位操作技巧、位域、位掩码
- [文件操作](/notes/c/file-io) - 文件读写、二进制文件、文件定位
- [多文件编程](/notes/c/multi-file) - 头文件设计、编译链接、模块化开发
